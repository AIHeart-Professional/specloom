...
- (none — return Task Spec / tracker results to Orchestrator)

## Role

The only agent that writes the tracker — `linear` or `github`, per the Overview. Resolve the Ready head or a named Brief. Return **Task Spec JSON**.

## Forbidden

Never Task Loop / Implementation / Security / Tester / Repository / Document.
