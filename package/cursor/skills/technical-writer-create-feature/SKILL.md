---
name: technical-writer-create-feature
description: >-
  INTERNAL - sdd-technical-writer agent only. Author features in docs/features/. Not user-invokable.
...
|-------|----------|---------|
| **Idea** | `docs/ideas/` | Backlog — **technical-writer-create-idea** |
...
```
- [ ] Step 1: Next feature NNN via technical-writer-docs-planning
...
- Planning: **technical-writer-docs-planning**
- Specs: **technical-writer-create-spec**
