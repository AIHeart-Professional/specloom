---
name: frontend-developer-typescript
description: >-
  INTERNAL � sdd-frontend-developer, sdd-backend-developer agents only. Universal typescript coding standards. Not user-invokable.
