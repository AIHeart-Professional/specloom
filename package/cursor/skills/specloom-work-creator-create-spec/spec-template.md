...
| Path | Purpose |
|------|---------|
| `docs/phases/01-Prototype/PHASE.md` | **Active product phase** � in/out of scope, quality bar |
...
**Phase rule:** `parent_phase` / phase `PHASE.md` path is **mandatory** � validators and testers score phase alignment.
