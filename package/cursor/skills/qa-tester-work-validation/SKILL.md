---
name: qa-tester-work-validation
description: >-
  INTERNAL — sdd-qa-tester agent only. Code alignment + quality scores 0-100.
...
Invoked by **sdd-qa-tester** when `validation_type: work`.
...
**sdd-project-lead** routes to domain agents. Max **3** (`workValidationAttempts`).
