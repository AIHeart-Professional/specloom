---
name: technical-writer-create-spec
description: >-
  INTERNAL — sdd-technical-writer agent only. Author docs/specs/ with Required Context. Not user-invokable.
...
12. **Work Records path:** `docs/specs/work-records/SPEC-{spec_id}/` — populated after **sdd-qa-tester** passes (not at spec creation)
...
- Features: **technical-writer-create-feature**
- Execute via **sdd-project-lead** → **sdd-technical-writer** (this skill).
- Structure: **technical-writer-docs-structure**
