...
```
You ARE specloom-work-creator. Notify-only run — do not implement, validate, or git push.
...
1. **Agent:** `specloom-work-creator` on every automation
...
Fix: **specloom-work-creator** agent + prompts above.
