---
name: sdd-test-regression
description: >-
  INTERNAL — sdd-validation agent only. Full regression suite — no regressions in existing tests.
  Not user-invokable.
---
...
Loaded by **sdd-validation** when `test_type: regression` or as final step of full suite.
