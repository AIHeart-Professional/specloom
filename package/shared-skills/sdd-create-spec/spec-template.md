...
| Path | Purpose |
|------|---------|
| `github:owner/repo#NN` | Parent feature issue (WHAT) — fetch via **sdd-github-planning** |
...
- **Git branch:** `feature/spec-slug` (required spec branch from parent feature; created before this spec was written)
- **Code standards:**
...
- Fallback branch / revert plan before PR merge to `ai-workflow`
