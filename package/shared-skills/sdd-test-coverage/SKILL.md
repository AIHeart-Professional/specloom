---
name: sdd-test-coverage
description: >-
  INTERNAL — sdd-validation agent only. Coverage validation — 100% on spec-touched files.
  Not user-invokable.
---
...
Loaded by **sdd-validation** after unit tests or during full suite. **Mandatory gate.**
...
**sdd-orchestrator** routes test writing fixes to domain agents — **sdd-validation** does not write production or test code unless handoff `action: write_tests` explicitly set for remediation pass.
